...
**本项目是为了让更多受众享受开源代码的“有趣创意”（而不局限于工程师项目），一键安装，秒成"豆包手机"，进入虚拟游戏的世界，AI底层基建、科幻故事感建构，剧本杀与密室元素渗透，提供一种想象“AI手机”的游戏实验。**
...
1.  **大脑 (Brain)**: Python 层运行 AutoGLM Agent，负责 **调用 LLM 进行推理** 与任务规划。
